...
import { highlights, featureList, introItemList } from '@/staticData/projects/werace'
  ...
  <div class="main-container">
    <section id="welcome">
      ...
      <div class="content-layer">
        <div class="intro">
          <h1 class="main-title">WeRace</h1>
          <div class="introduction">窥见全栈 —— 不只是课设：H5C3 + PHP + MySQL</div>
        </div>
...
#welcome {
  ...
  .background-layer {
    ...
    width: 100%;
    height: 100%;
    background: url('@/assets/images/werace/amgone.jpeg') no-repeat bottom right/cover;
  }
...
@keyframes scroll {
  to {
    ...
    transform: translateY(calc(-1 * 40px * 13));
  }
}
