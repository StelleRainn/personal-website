...
```text
公安备案编号：桂公网安备45012402000043号
查询地址：https://beian.mps.gov.cn/#/query/webSearch?code=45012402000043
```

备案平台提供的原始图标和链接代码保存在 `appendix/public_security/`，首页使用的图标副本位于 `src/assets/public-security-record.png`。
...
ICP备案与公安联网备案均已完成。网站首页底部需要长期保留以下两项信息：
